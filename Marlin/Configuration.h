...
#define STRING_CONFIG_H_AUTHOR "(rheinz) SKR1.4T/TMC2209/BLTouch" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "IdA7-10S"
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -44, -14, -0.5 }
